...
public class ViewTaskActivity extends PinCodeActivity implements StepCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.rsf_activity_step_switcher);
    ...
    private void showStep(Step step) {
        ...
        stepLayout.getLayout().setTag(R.id.rsf_step_layout_id, step.getIdentifier());
    ...
    private void notifyStepOfBackPress() {
        StepLayout currentStepLayout = (StepLayout) findViewById(R.id.rsf_current_step);
