package org.researchstack.foundation.components.consent.model;
...
public class ConsentSection implements Serializable {
    ...
    public enum Type implements Serializable {
        ...
        public int getTitleResId() {
            switch (this) {
                case Overview:
                    return R.string.rsf_consent_section_welcome;
                case DataGathering:
                    return R.string.rsf_consent_section_data_gathering;
                case Privacy:
                    return R.string.rsf_consent_section_privacy;
                case DataUse:
                    return R.string.rsf_consent_section_data_use;
                case TimeCommitment:
                    return R.string.rsf_consent_section_time_commitment;
                case StudySurvey:
                    return R.string.rsf_consent_section_study_survey;
                case StudyTasks:
                    return R.string.rsf_consent_section_study_tasks;
                case Withdrawing:
                    return R.string.rsf_consent_section_withdrawing;
                default:
                    return -1;
            }
        }
        ...
        public String getImageName() {
            switch (this) {
                case DataGathering:
                    return "rsf_consent_section_data_gathering";
                case Privacy:
                    return "rsf_consent_section_privacy";
                case DataUse:
                    return "rsf_consent_section_data_use";
                case TimeCommitment:
                    return "rsf_consent_section_time_commitment";
                case StudySurvey:
                    return "rsf_consent_section_study_survey";
                case StudyTasks:
                    return "rsf_consent_section_study_tasks";
                case Withdrawing:
                    return "rsf_consent_section_withdrawing";
                default:
                    return null;
            }
        }
        ...
        public int getMoreInfoResId() {
            switch (this) {
                case Overview:
                    return R.string.rsf_consent_section_more_info_welcome;
                case DataGathering:
                    return R.string.rsf_consent_section_more_info_data_gathering;
                case Privacy:
                    return R.string.rsf_consent_section_more_info_privacy;
                case DataUse:
                    return R.string.rsf_consent_section_more_info_data_use;
                case TimeCommitment:
                    return R.string.rsf_consent_section_more_info_time_commitment;
                case StudySurvey:
                    return R.string.rsf_consent_section_more_info_study_survey;
                case StudyTasks:
                    return R.string.rsf_consent_section_more_info_study_tasks;
                case Withdrawing:
                    return R.string.rsf_consent_section_more_info_withdrawing;
                default:
                    return R.string.rsf_consent_section_more_info;
            }
        }
