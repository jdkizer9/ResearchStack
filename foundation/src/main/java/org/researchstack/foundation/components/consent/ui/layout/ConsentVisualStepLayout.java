...
import org.researchstack.foundation.components.consent.model.ConsentSection;
import org.researchstack.foundation.components.consent.step.ConsentVisualStep;
...
public class ConsentVisualStepLayout extends FixedSubmitBarLayout implements StepLayout {
    ...
    public int getContentResourceId() {
        return R.layout.rsf_step_layout_consent_visual;
    }
    ...
    private void initializeStep() {
        ...
        if (!TextUtils.isEmpty(data.getHtmlContent())) {
            ...
            RxView.clicks(moreInfoView).subscribe(v -> {
                String webTitle = getResources().getString(R.string.rsf_consent_section_more_info);
