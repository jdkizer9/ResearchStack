...
import org.researchstack.foundation.components.consent.step.ConsentSignatureStep;
import org.researchstack.foundation.components.consent.ui.callbacks.SignatureCallbacks;
import org.researchstack.foundation.components.consent.ui.views.SignatureView;
...
public class ConsentSignatureStepLayout extends RelativeLayout implements StepLayout {
    ...
    private void initializeStep() {
        LayoutInflater.from(getContext())
                .inflate(R.layout.rsf_step_layout_consent_signature, this, true);
