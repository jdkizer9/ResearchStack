...
class BackwardsCompatibleTaskPresentationFragment: TaskPresentationFragment<Step, TaskResult, Task>(), StepCallbacks {
    ...
    companion object {
        ...
        fun newInstance(
                ...
                callback: TaskPresentationCallback<Step, TaskResult, Task>
