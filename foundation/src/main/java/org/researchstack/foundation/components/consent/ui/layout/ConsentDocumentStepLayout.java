package org.researchstack.foundation.components.consent.ui.layout;
...
import org.researchstack.foundation.components.consent.step.ConsentDocumentStep;
...
public class ConsentDocumentStepLayout extends LinearLayout implements StepLayout {
    ...
    private void initializeStep() {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.rsf_step_layout_consent_doc, this, true);
    ...
    private void showDialog() {
        new AlertDialog.Builder(getContext()).setTitle(R.string.rsf_consent_review_alert_title)
                ...
                .setNegativeButton(R.string.rsf_consent_review_cancel, (dialog, which) -> {
